...
class option_map(object):
    ...
    report_unused_options = _swig_new_instance_method(
...
class formula(object):
    ...
    is_syntactic_guarantee = _swig_new_instance_method(
        _impl.formula_is_syntactic_guarantee
    )
    is_syntactic_obligation = _swig_new_instance_method(
        _impl.formula_is_syntactic_obligation
    )
    is_syntactic_recurrence = _swig_new_instance_method(
        _impl.formula_is_syntactic_recurrence
    )
    is_syntactic_persistence = _swig_new_instance_method(
    ...
    has_spin_atomic_props = _swig_new_instance_method(
...
class pair_formula_vectorstring(object):
    ...
    def __init__(self, *args):
        _impl.pair_formula_vectorstring_swiginit(
            self, _impl.new_pair_formula_vectorstring(*args)
        )

    first = property(
        _impl.pair_formula_vectorstring_first_get,
        _impl.pair_formula_vectorstring_first_set,
    )
    second = property(
        _impl.pair_formula_vectorstring_second_get,
        _impl.pair_formula_vectorstring_second_set,
    )
...
class declarative_environment(environment):
    ...
    def __init__(self):
        _impl.declarative_environment_swiginit(
            self, _impl.new_declarative_environment()
        )
...
class bdd_dict(object):
    ...
    has_registered_proposition = _swig_new_instance_method(
        _impl.bdd_dict_has_registered_proposition
    )
    varnum = _swig_new_instance_method(_impl.bdd_dict_varnum)
    register_acceptance_variable = _swig_new_instance_method(
    ...
    register_proposition = _swig_new_instance_method(
        _impl.bdd_dict_register_proposition
    )
    unregister_all_my_variables = _swig_new_instance_method(
    ...
    register_all_variables_of = _swig_new_instance_method(
        _impl.bdd_dict_register_all_variables_of
    )
    register_anonymous_variables = _swig_new_instance_method(
...
class acc_cond(object):
    ...
    set_generalized_buchi = _swig_new_instance_method(
        _impl.acc_cond_set_generalized_buchi
    )
    set_generalized_co_buchi = _swig_new_instance_method(
        _impl.acc_cond_set_generalized_co_buchi
    )
    is_generalized_buchi = _swig_new_instance_method(
        _impl.acc_cond_is_generalized_buchi
    )
    is_generalized_co_buchi = _swig_new_instance_method(
    ...
    is_generalized_rabin = _swig_new_instance_method(
...
class acc_code(object):
    ...
    useless_colors_patterns = _swig_new_instance_method(
        _impl.acc_code_useless_colors_patterns
    )
...
class state_shared_ptr_less_than(object):
    ...
    def __init__(self):
        _impl.state_shared_ptr_less_than_swiginit(
            self, _impl.new_state_shared_ptr_less_than()
        )
...
class twa(object):
    ...
    copy_named_properties_of = _swig_new_instance_method(
        _impl.twa_copy_named_properties_of
    )
    ...
    release_named_properties = _swig_new_instance_method(
    ...
    def prop_deterministic(self, *args):
        ...
        warn("use prop_universal() instead of prop_deterministic()", DeprecationWarning)

        return _impl.twa_prop_deterministic(self, *args)

    prop_unambiguous = _swig_new_instance_method(_impl.twa_prop_unambiguous)
    prop_semi_deterministic = _swig_new_instance_method(
...
class twa_prop_set(object):
    ...
    __repr__ = _swig_repr
    state_based = property(
        _impl.twa_prop_set_state_based_get, _impl.twa_prop_set_state_based_set
    )
    inherently_weak = property(
        _impl.twa_prop_set_inherently_weak_get, _impl.twa_prop_set_inherently_weak_set
    )
    deterministic = property(
        _impl.twa_prop_set_deterministic_get, _impl.twa_prop_set_deterministic_set
    )
    improve_det = property(
        _impl.twa_prop_set_improve_det_get, _impl.twa_prop_set_improve_det_set
    )
    complete = property(
        _impl.twa_prop_set_complete_get, _impl.twa_prop_set_complete_set
    )
    stutter_inv = property(
        _impl.twa_prop_set_stutter_inv_get, _impl.twa_prop_set_stutter_inv_set
    )
...
class language_containment_checker(object):
    ...
    def __init__(self, *args):
        _impl.language_containment_checker_swiginit(
            self, _impl.new_language_containment_checker(*args)
        )
    ...
    neg_contained = _swig_new_instance_method(
        _impl.language_containment_checker_neg_contained
    )
    contained_neg = _swig_new_instance_method(
...
class tl_simplifier_options(object):
    ...
    def __init__(self, *args):
        _impl.tl_simplifier_options_swiginit(
            self, _impl.new_tl_simplifier_options(*args)
        )

    reduce_basics = property(
...
class tl_simplifier(object):
    ...
    negative_normal_form = _swig_new_instance_method(
        _impl.tl_simplifier_negative_normal_form
    )
    syntactic_implication = _swig_new_instance_method(
        _impl.tl_simplifier_syntactic_implication
    )
    syntactic_implication_neg = _swig_new_instance_method(
    ...
    clear_as_bdd_cache = _swig_new_instance_method(
...
class randltlgenerator(object):
    ...
    dump_ltl_priorities = _swig_new_instance_method(
        _impl.randltlgenerator_dump_ltl_priorities
    )
    dump_bool_priorities = _swig_new_instance_method(
        _impl.randltlgenerator_dump_bool_priorities
    )
    dump_psl_priorities = _swig_new_instance_method(
        _impl.randltlgenerator_dump_psl_priorities
    )
    dump_sere_priorities = _swig_new_instance_method(
        _impl.randltlgenerator_dump_sere_priorities
    )
    dump_sere_bool_priorities = _swig_new_instance_method(
        _impl.randltlgenerator_dump_sere_bool_priorities
    )
    remove_some_props = _swig_new_instance_method(
...
class twa_product_init(twa_product):
    ...
    def __init__(self, left, right, left_init, right_init):
        _impl.twa_product_init_swiginit(
            self, _impl.new_twa_product_init(left, right, left_init, right_init)
        )
...
class const_universal_dests(object):
    ...
    def __init__(self, *args):
        _impl.const_universal_dests_swiginit(
            self, _impl.new_const_universal_dests(*args)
        )
...
class twa_graph_edge_data(object):
    ...
    __repr__ = _swig_repr
    cond = property(
        _impl.twa_graph_edge_data_cond_get, _impl.twa_graph_edge_data_cond_set
    )
...
class twa_graph(twa):
    ...
    get_init_state_number = _swig_new_instance_method(
...
class twa_graph_killer_edge_iterator(object):
    ...
    def __init__(self, g, t, src):
        _impl.twa_graph_killer_edge_iterator_swiginit(
            self, _impl.new_twa_graph_killer_edge_iterator(g, t, src)
        )
...
class twa_graph_edge_boxed_data(twa_graph_edge_data):
    ...
    def __init__(self):
        _impl.twa_graph_edge_boxed_data_swiginit(
            self, _impl.new_twa_graph_edge_boxed_data()
        )
...
class twa_graph_edge_storage(twa_graph_edge_boxed_data):
    ...
    __repr__ = _swig_repr
    dst = property(
        _impl.twa_graph_edge_storage_dst_get, _impl.twa_graph_edge_storage_dst_set
    )
    next_succ = property(
    ...
    src = property(
        _impl.twa_graph_edge_storage_src_get, _impl.twa_graph_edge_storage_src_set
    )
...
class twa_univ_remover(twa):
    ...
    allocate_state_vars = _swig_new_instance_method(
...
class nca_st_info(object):
    ...
    __repr__ = _swig_repr
    clause_num = property(
        _impl.nca_st_info_clause_num_get, _impl.nca_st_info_clause_num_set
    )
    state_num = property(
        _impl.nca_st_info_state_num_get, _impl.nca_st_info_state_num_set
    )
...
class emptiness_check_result(object):
    ...
    def __init__(self, *args):
        _impl.emptiness_check_result_swiginit(
            self, _impl.new_emptiness_check_result(*args)
        )

    __swig_destroy__ = _impl.delete_emptiness_check_result
    accepting_run = _swig_new_instance_method(
    ...
    parse_options = _swig_new_instance_method(
...
class emptiness_check(object):
    ...
    emptiness_check_statistics = _swig_new_instance_method(
...
class emptiness_check_instantiator(object):
    ...
    __repr__ = _swig_repr
    instantiate = _swig_new_instance_method(
...
class twa_run(object):
    ...
    ensure_non_empty_cycle = _swig_new_instance_method(
...
class keep_inner_scc(object):
    ...
    def __init__(self, sccof, desired_scc):
        _impl.keep_inner_scc_swiginit(
            self, _impl.new_keep_inner_scc(sccof, desired_scc)
        )
...
scc_info_options_TRACK_STATES_IF_FIN_USED = (
...
class scc_info(object):
    ...
    is_maximally_accepting_scc = _swig_new_instance_method(
        _impl.scc_info_is_maximally_accepting_scc
    )
    determine_unknown_acceptance = _swig_new_instance_method(
    ...
    states_on_acc_cycle_of = _swig_new_instance_method(
...
class scc_and_mark_filter(object):
    ...
    override_acceptance = _swig_new_instance_method(
        _impl.scc_and_mark_filter_override_acceptance
    )
    restore_acceptance = _swig_new_instance_method(
...
class scc_info_scc_edges(object):
    ...
    def __init__(self, begin, end, tv, sv, dv, filt, efilter, efilter_data):
        _impl.scc_info_scc_edges_swiginit(
            self,
            _impl.new_scc_info_scc_edges(
                begin, end, tv, sv, dv, filt, efilter, efilter_data
            ),
        )
...
class scc_info_inner_scc_edges(object):
    ...
    def __init__(self, begin, end, tv, sv, dv, filt, efilter, efilter_data):
        _impl.scc_info_inner_scc_edges_swiginit(
            self,
            _impl.new_scc_info_inner_scc_edges(
                begin, end, tv, sv, dv, filt, efilter, efilter_data
            ),
        )
...
class reduce_parity_data(object):
    ...
    __repr__ = _swig_repr
    parity_max = property(
        _impl.reduce_parity_data_parity_max_get, _impl.reduce_parity_data_parity_max_set
    )
    parity_odd = property(
        _impl.reduce_parity_data_parity_odd_get, _impl.reduce_parity_data_parity_odd_set
    )
    piprime1 = property(
        _impl.reduce_parity_data_piprime1_get, _impl.reduce_parity_data_piprime1_set
    )
    piprime2 = property(
        _impl.reduce_parity_data_piprime2_get, _impl.reduce_parity_data_piprime2_set
    )

    def __init__(self, aut, layered=False):
        _impl.reduce_parity_data_swiginit(
            self, _impl.new_reduce_parity_data(aut, layered)
        )
...
class synthesis_info(object):
    ...
    force_sbacc = property(
        _impl.synthesis_info_force_sbacc_get, _impl.synthesis_info_force_sbacc_set
    )
    s = property(_impl.synthesis_info_s_get, _impl.synthesis_info_s_set)
    minimize_lvl = property(
        _impl.synthesis_info_minimize_lvl_get, _impl.synthesis_info_minimize_lvl_set
    )
    bv = property(_impl.synthesis_info_bv_get, _impl.synthesis_info_bv_set)
    verbose_stream = property(
        _impl.synthesis_info_verbose_stream_get, _impl.synthesis_info_verbose_stream_set
    )
...
class mealy_like(object):
    ...
    realizability_code_REALIZABLE_REGULAR = (
        _impl.mealy_like_realizability_code_REALIZABLE_REGULAR
    )
    realizability_code_REALIZABLE_DTGBA = (
        _impl.mealy_like_realizability_code_REALIZABLE_DTGBA
    )
    success = property(_impl.mealy_like_success_get, _impl.mealy_like_success_set)
    mealy_like = property(
        _impl.mealy_like_mealy_like_get, _impl.mealy_like_mealy_like_set
    )
...
class hoa_alias_formater(object):
    ...
    def __init__(
        ...
        _impl.hoa_alias_formater_swiginit(
            self,
            _impl.new_hoa_alias_formater(
                aut,
                false_str,
                true_str,
                or_str,
...
class to_parity_data(object):
    ...
    __repr__ = _swig_repr
    nb_states_created = property(
        _impl.to_parity_data_nb_states_created_get,
        _impl.to_parity_data_nb_states_created_set,
    )
    nb_edges_created = property(
        _impl.to_parity_data_nb_edges_created_get,
        _impl.to_parity_data_nb_edges_created_set,
    )
    algorithms_used = property(
        _impl.to_parity_data_algorithms_used_get,
        _impl.to_parity_data_algorithms_used_set,
    )
...
class to_parity_options(object):
    ...
    __repr__ = _swig_repr
    search_ex = property(
        _impl.to_parity_options_search_ex_get, _impl.to_parity_options_search_ex_set
    )
    use_last = property(
        _impl.to_parity_options_use_last_get, _impl.to_parity_options_use_last_set
    )
    use_last_post_process = property(
        _impl.to_parity_options_use_last_post_process_get,
        _impl.to_parity_options_use_last_post_process_set,
    )
    force_order = property(
        _impl.to_parity_options_force_order_get, _impl.to_parity_options_force_order_set
    )
    partial_degen = property(
        _impl.to_parity_options_partial_degen_get,
        _impl.to_parity_options_partial_degen_set,
    )
    acc_clean = property(
        _impl.to_parity_options_acc_clean_get, _impl.to_parity_options_acc_clean_set
    )
    parity_equiv = property(
    ...
    lar_dfs = property(
        _impl.to_parity_options_lar_dfs_get, _impl.to_parity_options_lar_dfs_set
    )
    bscc = property(_impl.to_parity_options_bscc_get, _impl.to_parity_options_bscc_set)
    parity_prefix = property(
        _impl.to_parity_options_parity_prefix_get,
        _impl.to_parity_options_parity_prefix_set,
    )
    parity_prefix_general = property(
        _impl.to_parity_options_parity_prefix_general_get,
        _impl.to_parity_options_parity_prefix_general_set,
    )
    generic_emptiness = property(
        _impl.to_parity_options_generic_emptiness_get,
        _impl.to_parity_options_generic_emptiness_set,
    )
    rabin_to_buchi = property(
        _impl.to_parity_options_rabin_to_buchi_get,
        _impl.to_parity_options_rabin_to_buchi_set,
    )
    buchi_type_to_buchi = property(
        _impl.to_parity_options_buchi_type_to_buchi_get,
        _impl.to_parity_options_buchi_type_to_buchi_set,
    )
    parity_type_to_parity = property(
        _impl.to_parity_options_parity_type_to_parity_get,
        _impl.to_parity_options_parity_type_to_parity_set,
    )
    reduce_col_deg = property(
        _impl.to_parity_options_reduce_col_deg_get,
        _impl.to_parity_options_reduce_col_deg_set,
    )
    propagate_col = property(
        _impl.to_parity_options_propagate_col_get,
        _impl.to_parity_options_propagate_col_set,
    )
    use_generalized_rabin = property(
        _impl.to_parity_options_use_generalized_rabin_get,
        _impl.to_parity_options_use_generalized_rabin_set,
    )
    ...
    datas = property(
        _impl.to_parity_options_datas_get, _impl.to_parity_options_datas_set
    )
...
class fair_kripke(twa):
    ...
    state_acceptance_mark = _swig_new_instance_method(
...
class kripke_graph_state_out(object):
    ...
    def __init__(self, g, t):
        _impl.kripke_graph_state_out_swiginit(
            self, _impl.new_kripke_graph_state_out(g, t)
        )
...
class kripke_graph_all_trans(object):
    ...
    def __init__(self, tv):
        _impl.kripke_graph_all_trans_swiginit(
            self, _impl.new_kripke_graph_all_trans(tv)
        )
...
class kripke_graph_edge_boxed_data(object):
    ...
    def __init__(self):
        _impl.kripke_graph_edge_boxed_data_swiginit(
            self, _impl.new_kripke_graph_edge_boxed_data()
        )
...
class kripke_graph_edge_storage(kripke_graph_edge_boxed_data):
    ...
    __repr__ = _swig_repr
    dst = property(
        _impl.kripke_graph_edge_storage_dst_get, _impl.kripke_graph_edge_storage_dst_set
    )
    next_succ = property(
    ...
    src = property(
        _impl.kripke_graph_edge_storage_src_get, _impl.kripke_graph_edge_storage_src_set
    )

    def __init__(self):
        _impl.kripke_graph_edge_storage_swiginit(
            self, _impl.new_kripke_graph_edge_storage()
        )
...
class kripke_graph_state_boxed_data(kripke_graph_state):
    ...
    def __init__(self):
        _impl.kripke_graph_state_boxed_data_swiginit(
            self, _impl.new_kripke_graph_state_boxed_data()
        )
...
class kripke_graph_state_storage(kripke_graph_state_boxed_data):
    ...
    def __init__(self):
        _impl.kripke_graph_state_storage_swiginit(
            self, _impl.new_kripke_graph_state_storage()
        )
...
class kripke_graph_state_vector(object):
    ...
    __getslice__ = _swig_new_instance_method(
        _impl.kripke_graph_state_vector___getslice__
    )
    __setslice__ = _swig_new_instance_method(
        _impl.kripke_graph_state_vector___setslice__
    )
    __delslice__ = _swig_new_instance_method(
    ...
    get_allocator = _swig_new_instance_method(
    ...
    def __init__(self, *args):
        _impl.kripke_graph_state_vector_swiginit(
            self, _impl.new_kripke_graph_state_vector(*args)
        )
...
class automaton_stream_parser(object):
    ...
    def __init__(self, *args):
        _impl.automaton_stream_parser_swiginit(
            self, _impl.new_automaton_stream_parser(*args)
        )
...
class ta(object):
    ...
    get_artificial_initial_state = _swig_new_instance_method(
    ...
    is_livelock_accepting_state = _swig_new_instance_method(
...
class tgta(twa):
    ...
    succ_iter_by_changeset = _swig_new_instance_method(
...
class ta_explicit(ta):
    ...
    def __init__(self, tgba, n_acc, artificial_initial_state=None):
        _impl.ta_explicit_swiginit(
            self, _impl.new_ta_explicit(tgba, n_acc, artificial_initial_state)
        )
    ...
    add_to_initial_states_set = _swig_new_instance_method(
    ...
    delete_stuttering_transitions = _swig_new_instance_method(
    ...
    set_artificial_initial_state = _swig_new_instance_method(
        _impl.ta_explicit_set_artificial_initial_state
    )
    delete_stuttering_and_hole_successors = _swig_new_instance_method(
...
class ta_explicit_succ_iterator(ta_succ_iterator):
    ...
    def __init__(self, *args):
        _impl.ta_explicit_succ_iterator_swiginit(
            self, _impl.new_ta_explicit_succ_iterator(*args)
        )
...
class tgta_explicit(tgta):
    ...
    def __init__(self, tgba, n_acc, artificial_initial_state):
        _impl.tgta_explicit_swiginit(
            self, _impl.new_tgta_explicit(tgba, n_acc, artificial_initial_state)
        )
